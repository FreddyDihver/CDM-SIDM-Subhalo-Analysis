...
The main analysis and plotting pipeline is implemented in `SubhaloPlotter.py`. An alternative color mesh plot for the 2D particle distribution only is implemented at `SubhaloColormeshPlotter.py`. 
